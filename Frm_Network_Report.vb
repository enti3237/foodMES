...
Public Class Frm_Network_Report
    Dim xlapp As Excel.Application
    Dim xlbook As Excel.Workbook
    Dim xlsheet As Excel.Worksheet
    Dim Excel_Check As Boolean
    Private Sub Frm_Network_Report_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Search_Com_Click(sender As Object, e As EventArgs) Handles Search_Com.Click
        ...
        StrSQL = "Select * From Login_Event with(NOLOCK) Where LOG_Date + LOG_Time >= '" & S_Day.Text & S_Time.Text & "' And LOG_Date + LOG_Time <= '" & E_Day.Text & E_Time.Text & "'   Order By LOG_Date, LOG_Time "
