Public Class Dia_Stock_barcode_print
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        '배열에서 값 가져오기
        Dim temp As Print.Pc_stock_print_data = barcode_ArrList.Item(pageNumber - 1)
    ...
    Private Sub Print_bnt_Click(sender As Object, e As EventArgs) Handles Print_bnt.Click
        ...
        If PrintDialog1.ShowDialog = Windows.Forms.DialogResult.OK Then
            ...
            Dim temp As Print.Pc_stock_print_data = barcode_ArrList.Item(Me.pageNumber - 1)
    ...
    Private Sub PictureBox1_Paint_update()
        ...
        '배열에서 값 가져오기
        Dim temp As Print.Pc_stock_print_data = barcode_ArrList.Item(now_page - 1)
