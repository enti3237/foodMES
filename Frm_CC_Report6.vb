...
Public Class Frm_CC_Report6
    ...
    Private Sub Search_Com_Click(sender As Object, e As EventArgs) Handles Search_Com.Click
        ...
        If Search_Combo_Name.Text = "전체" Then
            StrSQL = "select a.CR_Code, a.CR_Customer_Code, a.CR_Customer_Name, c.CL_PL_Code, c.CL_PL_Name, a.CR_Date, b.DL_Date, DATEDIFF(DAY,a.CR_Date,b.DL_Date) AS DUE , a.CR_Bigo 
                        FROM SC_SALES a join Deliver b on b.DL_Cr_Code = a.CR_Code
	                        join Contract_List c on c.CL_Code = a.CR_Code 
                        Where (CL_PL_CODE Is not null Or Len(CL_PL_CODE) > 5) And  Len(CL_PL_CODE) > 0 
                          AND a.CR_Date >= '" & S_Day.Text & "' AND  a.CR_Date<= '" & E_Day.Text & "'
                        group by a.CR_Code, c.CL_PL_Code, c.CL_PL_Name, a.CR_Date, b.DL_Date,a.CR_Customer_Code, a.CR_Customer_Name, a.CR_Bigo "
        Else
            StrSQL = "select a.CR_Code, a.CR_Customer_Code, a.CR_Customer_Name, c.CL_PL_Code, c.CL_PL_Name, a.CR_Date, b.DL_Date, DATEDIFF(DAY,a.CR_Date,b.DL_Date) AS DUE , a.CR_Bigo 
                        FROM SC_SALES a join Deliver b on b.DL_Cr_Code = a.CR_Code
	                        join Contract_List c on c.CL_Code = a.CR_Code 
                        Where (CL_PL_CODE Is not null Or Len(CL_PL_CODE) > 5) And  Len(CL_PL_CODE) > 0 
                        and CR_Customer_Code = '" & Search_Combo.Text & "'
                          AND a.CR_Date >= '" & S_Day.Text & "'  AND  a.CR_Date<= '" & E_Day.Text & "'
                        group by a.CR_Code, c.CL_PL_Code, c.CL_PL_Name, a.CR_Date, b.DL_Date,a.CR_Customer_Code, a.CR_Customer_Name, a.CR_Bigo "
        ...
        '    StrSQL = "Select Sum(Convert(Decimal,DL_Total)) As E1  FROM SC_DELIVER_LIST with(NOLOCK) Where DL_PL_Code = '" & Grid_Main.Item(1, i).Value & "'  Group By DL_PL_Code   "
        '    Re_Count = DB_Select(DBT)
        '    If Re_Count <> 0 Then
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        StrSQL = "select AVG(DATEDIFF(DAY,a.CR_Date,b.DL_Date)) as avg
                    FROM SC_SALES a join Deliver b on b.DL_Cr_Code = a.CR_Code
                     join Contract_List c on c.CL_Code = a.CR_Code 
                    Where (CL_PL_CODE Is not null Or Len(CL_PL_CODE) > 5) And  Len(CL_PL_CODE) > 0 
                      AND a.CR_Date >= '" & S_Day.Text & "'  AND a.CR_Date<= '" & E_Day.Text & "'"
