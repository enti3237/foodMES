...
Public Class Frm_Barcode
    ...
    Public Function Grid_Code_Display(Display_Sel As Boolean) As Boolean
        ...
        If Display_Sel Then
            ...
            Select Case Search_Combo.Text
                ...
                Case "품명"
                    StrSQL = "Select PL_Code, PL_Name, PL_Sel FROM SI_PRODUCT With(NOLOCK) Where PL_Name Like '%" & Search_Text.Text & "%'" & Je_Gu & "Order By PL_Name"
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Dim DBT As New DataTable
        Po_Num = ""
        StrSQL = "Select * FROM SI_BASE_CODE With(NOLOCK) Where Base_Sel = 'Port' And Base_Sun = '1'"
        Re_Count = DB_Select(DBT)
        If Re_Count <> 0 Then
            For i = 0 To Re_Count - 1
        ...
        For i = 1 To In_Box_Count
            ...
            SerialPort_Send("T230," & 20 + P_Cnt * P_Cnt_P & ",3,1,1,0,0,N,N,'SmartFoodMES - InBox'")
        ...
        For i = 1 To Out_Box_Count
            ...
            End If
            SerialPort_Send("SD20")
            SerialPort_Send("T230," & 20 + P_Cnt * P_Cnt_P & ",3,1,1,0,0,N,N,'SmartFoodMES - OutBox'")
