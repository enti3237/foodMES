...
Public Class Frm_Login
    ...
    Private Sub Com_Ok_Click(sender As Object, e As EventArgs) Handles Com_Ok.Click
        ...
        Try
            '요기부터
            If Text_Man_Code.Text = "" Or Text_Man_Code.Text = "100001" Then
                Frm_Main.Show()
                Frm_Main.Text_Man_Code.Text = "100001"
    ...
    Private Sub Frm_Login_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        ...
        'ccp 및 품질현황
        If Setup_Data(1) = "Monitoring2" Then
        ...
        'ccp 공정 모니터링
        If Setup_Data(1) = "Monitoring3" Then
        ...
        '재고현황
        If Setup_Data(1) = "Monitoring4" Then
        ...
        '종합현황
        If Setup_Data(1) = "Monitoring5" Then
