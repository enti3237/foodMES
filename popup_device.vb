Public Class popup_device
    'Dim sel_Row As Integer
    'Dim sel_Col As Integer

    Public DEVICE_NAME As String '품명
    Public DEVICE_CODE As String '코드
    ...
    Public Function DataGridView1_Setup() As Boolean
        ...
        StrSQL = "select PD_CODE, PD_NAME, PD_BIGO from SI_MACHINE "
    ...
    Private Sub DataGridView1_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles DataGridView1.MouseDoubleClick
        ...
        DEVICE_CODE = DataGridView1.Rows(DataGridView1.CurrentRow.Index).Cells(0).Value.ToString()
        DEVICE_NAME = DataGridView1.Rows(DataGridView1.CurrentRow.Index).Cells(1).Value.ToString()
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        StrSQL = "select PD_CODE, PD_NAME, PD_BIGO from SI_MACHINE WHERE PD_Name Like'%" + viewbox1.Text + "%' OR PD_CODE Like'%" + viewbox1.Text + "%' "
