...
Public Class Frm_Login_Report
    ...
    Public Function S_Text_Setup() As Boolean
        ...
        StrSQL = "Select * FROM SI_MAN with(NOLOCK) Order By Man_Code"
    ...
    Private Sub ComboBox1_SelectionChangeCommitted(sender As Object, e As EventArgs) Handles ComboBox1.SelectionChangeCommitted
        Dim DBT As New DataTable
        StrSQL = "Select * FROM SI_MAN with(NOLOCK) Where Man_Code = '" & ComboBox1.SelectedItem.ToString() & "'"
        Re_Count = DB_Select(DBT)
        If Re_Count <> 0 Then
            ComboBox2.Text = DBT.Rows(0)("Man_Name")
        End If
    ...
    Private Sub ComboBox2_SelectionChangeCommitted(sender As Object, e As EventArgs) Handles ComboBox2.SelectionChangeCommitted
        Dim DBT As New DataTable
        StrSQL = "Select * FROM SI_MAN with(NOLOCK) Where Man_Name = '" & ComboBox2.SelectedItem.ToString() & "'"
        Re_Count = DB_Select(DBT)
        If Re_Count <> 0 Then
            ComboBox1.Text = DBT.Rows(0)("Man_Code")
        End If
