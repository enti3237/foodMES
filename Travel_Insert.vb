Public Class Travel_Insert
    ...
    Private Sub Btn_Save_Click(sender As Object, e As EventArgs) Handles Btn_Save.Click
        ...
        where QC_CODE = '" & QC_CODE.Text & "'"
                ...
                '로그
                StrSQL = "SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED "
                StrSQL = StrSQL & "Insert INTO MAN_LOG Values ('" & DateTime.Now & "', '" & Me.Name & "', '공정검사 추가', '" & Frm_Main.Text_Man_Name.Text & "',
                                                                     '" & QC_CODE.Text & " 공정검사 입력')"
                Re_Count = DB_Execute()
        ...
        ElseIf Label1.Text = "update" Then
            ...
            Try
                ...
                StrSQL = "SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED "
                StrSQL = StrSQL & "Insert INTO MAN_LOG Values ('" & DateTime.Now & "', '" & Me.Name & "', '공정검사 수정', '" & Frm_Main.Text_Man_Name.Text & "',
                                                                     '" & QC_CODE.Text & " 공정검사 수정')"
                Re_Count = DB_Execute()
            Catch ex As Exception
                MsgBox(ex.Message)
            End Try
