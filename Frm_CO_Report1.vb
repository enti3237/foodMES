...
Public Class Frm_CO_Report1
    ...
    Private Sub Search_Com_Click(sender As Object, e As EventArgs) Handles Search_Com.Click
        ...
        StrSQL = "Select CR_Date, CL_PL_Code, CL_PL_Name, CL_Standard, CL_Unit, CL_Unit_Amount, CL_Total  FROM SC_SALES with(NOLOCK), SC_SALES_LIST with(NOLOCK)  Where CL_Code = CR_Code And CR_Date + CR_Time >= '" & S_Day.Text & S_Time.Text & "' And CR_Date + CR_Time <= '" & E_Day.Text & E_Time.Text & "'  And Len(CL_PL_Code) > 0 Order By CR_Date, CR_Time "
