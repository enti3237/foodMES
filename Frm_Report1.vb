...
Public Class Frm_Report1
    ...
    Public Function Grid_Main_Setup() As Boolean
        ...
        Grid_Main.Columns(2).HeaderText = "공정명"
        Grid_Main.Columns(3).HeaderText = "투입수량"
        Grid_Main.Columns(4).HeaderText = "생산수량"
        Grid_Main.Columns(5).HeaderText = "불량수량"
