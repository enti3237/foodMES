Public Class Frm_Main
    ...
    Private Function Main_load()
        ...
        D = GetForm("SmartFoodMES", "Frm_Begin")
    ...
    Private Sub Menu_Set()
        ...
        Dim i As Integer
        Dim j As Integer
        StrSQL = "Select * From Menu_Setup_" & Setup_Data(9) & " With(NOLOCK) Order By Sun"
        Re_Count = DB_Select(DBT)
        If Re_Count <> 0 Then
            For i = 0 To Re_Count - 1
                Menu_String(i, 0) = DBT.Rows(i)("Main_Menu").ToString

                'For j = 2 To 9 '화면상 보여지는 탭개수조정 ' max = row 개수
                For j = 2 To 19 '메인모듈 스트링 개수도 같이 조절할것
    ...
    Private Sub Sub_Menu1_Click(sender As Object, e As EventArgs)
        ...
        'If sender.text = "CCP 모니터링" Then
        '    Frm_Monitoring3.Show()
        '    Exit Sub
        'End If

        If sender.text = "CCP현황" Then
            Frm_Monitoring2.Show()
            Exit Sub
        End If

        'If sender.text = "생산현황" Then
        '    Frm_Monitoring.Show()
        '    Exit Sub
        'End If

        If sender.text = "종합현황" Then
            Frm_Monitoring5.Show()
            Exit Sub
        End If

        'If sender.text = "재고현황" Then
        '    Frm_Monitoring4.Show()
        '    Exit Sub
        'End If
        ...
        Dim D As Object
        For i = 0 To 10
            For j = 1 To 19 '클릭했을 때 화면 안뜨면 조정하기 (10 -> 17)
                If sender.text = Menu_String(i, j) Then
                    D = GetForm("SmartFoodMES", Menu_String(i + 10, j)) '기준점
                End If
            Next j
        Next i
        Form_Array.Add(Tab_Menu_Title_Count, D)
    ...
    End Sub
    Private Sub Main_Menu1_Click(sender As Object, e As EventArgs) Handles Main_Menu8.Button_Menu_Click_Data, Main_Menu9.Button_Menu_Click_Data, Main_Menu7.Button_Menu_Click_Data, Main_Menu6.Button_Menu_Click_Data, Main_Menu5.Button_Menu_Click_Data, Main_Menu4.Button_Menu_Click_Data, Main_Menu3.Button_Menu_Click_Data, Main_Menu2.Button_Menu_Click_Data, Main_Menu1.Button_Menu_Click_Data
        Dim i As Integer
